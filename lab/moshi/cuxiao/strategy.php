...
class Cash_context{
	private $cs;
	public function __construct($cash_super)
	{
		$this->cs = $cash_super;
	}
...
switch($type){
	case "1":
		$cs = new Cash_context(new Cash_normal());
		break;
	case "2":
		$cs = new Cash_context(new Cash_return("300", "100"));
		break;
	case "3":
		$cs = new Cash_context(new Cash_rebate("0.8"));
		break;
}
$total_price = 0;
